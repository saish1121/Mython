...
def main():
    ...
    print("Common pattern which i observed is :\nThe output is weighted towards attendance if attendance is in the passing range the output tends to be pass,else fails.")
